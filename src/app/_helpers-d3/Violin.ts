...
class Chart {
  ...
  constructor(private elementHTML: any, data: any[], groupes: any[]) {
    this.data = data;
...
export default function Violin(elementHtml: any, data: any[], groupes: any[]) {
  new Chart(elementHtml, data, groupes);
}
